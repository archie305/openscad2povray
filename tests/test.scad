...
module test2() // Direct Test
{
    ...
    {
        obj();
        _mirror([1,2,3]) _translate([30,0,0]) obj();
    }
}
...
module test3() // Indirect Test
{
    ...
    translate([100,0,5]) obj(5,[1,.5,.5,.5]*.8);
    translate([100,15,4]) rotate([0,10,0]) obj(4,[0.5,1,.5,.5]*.8);
    translate([80,0,10]) rotate([10,0,0]) obj(10,[0.5,0.5,1,.5]*.8);
